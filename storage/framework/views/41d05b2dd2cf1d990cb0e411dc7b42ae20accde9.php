...
unset($__errorArgs, $__bag); ?>" id="nama" placeholder="Nama Lengkap" name="nama" value="<?php echo e(old('nama')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="nrp" placeholder="NRP" name="nrp" value="<?php echo e(old('nrp')); ?>">
                    <?php $__errorArgs = ['nrp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="jurusan" placeholder="Jurusan" name="jurusan" value="<?php echo e(old('jurusan')); ?>">
